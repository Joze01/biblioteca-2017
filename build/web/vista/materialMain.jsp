                      ...
                      <div id="step-1">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="number" max="2017" min="100" id="descripcion" name="year" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="number" max="1000" min="0" id="descripcion" name="edicion" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
